...
obj.bigsnp = snp_attach("/ysm-gpfs/pi/zhao/gz222/UKB_real/ref/ldpred2_MHC/1kghm3.rds")
...
for (chr in 1:22) {
    ...
    # read corr
    corr0 = readRDS(paste0("/ysm-gpfs/pi/zhao/gz222/UKB_real/ref/ldpred2_MHC/1kg_mh3_ldpred2_chr",chr,".rds"))[ind.chr3, ind.chr3]
...
write.table(res, file=paste0("ldpred2.txt"), row.names=F, col.names=F, quote=F, append=F)
