...
do
    ...
    do
	Rscript ${DBSLMM} --summary ./gemma.assoc.txt --outPath ./ --plink plink --dbslmm ${dbslmm} --ref /ysm-gpfs/pi/zhao/gz222/1000g_phase3/genotype_1KG_eur_SNPmaf5/hm3/eur_SNPmaf5_nomhc --pv ${pv} --r2 ${r2} --mafMax 1 --n 61294 --nsnp ${m} --type d --block ${blockf}.bed --h2 0.09 --thread 3    	
