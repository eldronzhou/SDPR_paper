#!/usr/bin/bash
#SBATCH --partition bigmem,general,scavenge
#SBATCH -c 1
#SBATCH --mem 100g
...
plink --bfile /ysm-gpfs/pi/zhao/gz222/UKB_simulate/genotype/test/test_10K --score sim_${i}_scaled.txt 1 2 3 header --out ../predict/gctb/sim_${i};
