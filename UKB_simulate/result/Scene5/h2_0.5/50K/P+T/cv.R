...
command = paste0("module load PLINK/1.90-beta5.3; plink --bfile /ysm-gpfs/pi/zhao/gz222/UKB_simulate/genotype/test/test_10K --extract sim_",j,"/clumped_",name,".snplist --score /ysm-gpfs/pi/zhao/gz222/UKB_simulate/summary_stat/",k,"/h2_",h2,"/",sz,"/sim_",j,".PHENO1.glm.linear 3 6 9 header --q-score-range range.txt /ysm-gpfs/pi/zhao/gz222/UKB_simulate/summary_stat/",k,"/h2_",h2,"/",sz,"/sim_",j,".PHENO1.glm.linear 3 12 header --out sim_",j,"/",name)
