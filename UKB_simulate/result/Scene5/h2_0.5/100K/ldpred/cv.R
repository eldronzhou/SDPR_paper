...
for (i in seq_along(file)) {
	command = paste0("module load PLINK/1.90-beta5.3; plink --bfile /ysm-gpfs/pi/zhao/gz222/UKB_simulate/genotype/validate/validate_10K --score ",file[i]," 3 4 7 header --out ",file[i] )
...
command = paste0("module load PLINK/1.90-beta5.3; plink --bfile /ysm-gpfs/pi/zhao/gz222/UKB_simulate/genotype/test/test_10K --score ", file[idx], " 3 4 7 header --out ../predict/ldpred/sim_",j)
