...
for (i in seq_along(file)) {
	command = paste0("plink --bfile ../../../../../genotype/validate/validate_10K --score ",file[i]," 2 4 6 --out ",file[i] )
...
command = paste0("plink --bfile ../../../../../genotype/test/test_10K --score ", file[idx], " 2 4 6  --out ../predict/PRS_CS/sim_",j)
