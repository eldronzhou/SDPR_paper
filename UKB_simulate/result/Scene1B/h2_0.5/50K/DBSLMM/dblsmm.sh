...
do
    ...
    do
	Rscript ${DBSLMM} --summary ../../../../../summary_stat/${j}/h2_0.5/${k}/sim_${i}_gemma.assoc.txt --outPath sim_${i}/ --plink plink --dbslmm ${dbslmm} --ref ../../../../../genotype/validate/validate_10K --pv ${pv} --r2 ${r2} --mafMax 1 --n 50000 --nsnp ${m} --type d --block ${blockf}.bed --h2 0.5 --thread 3
